defmodule Evision.Omnidir do
  ...
  def calibrate([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:imagePoints,:idx,:objectPoints,:tvecs,:flags,:rvecs,:criteria,:K,:D,:size,:xi])
  ...
  def initUndistortRectifyMap([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:R,:m1type,:flags,:size,:map2,:K,:D,:P,:xi,:map1])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
  ...
  def projectPoints([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:imagePoints,:rvec,:objectPoints,:K,:D,:tvec,:jacobian,:xi])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
  ...
  def stereoCalibrate([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:xi1,:imagePoints2,:imageSize1,:rvec,:idx,:objectPoints,:imagePoints1,:flags,:criteria,:xi2,:D2,:K1,:imageSize2,:D1,:K2,:tvecsL,:tvec,:rvecsL])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
  ...
  def stereoReconstruct([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:image2Rec,:D2,:K1,:K2,:image1,:xi1,:SADWindowSize,:R,:image1Rec,:pointCloud,:T,:xi2,:newSize,:D1,:pointType,:image2,:flag,:Knew,:disparity,:numDisparities])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
  ...
  def stereoRectify([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:T,:R,:R1,:R2])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
  ...
  def undistortImage([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:R,:flags,:xi,:new_size,:K,:Knew,:D,:distorted,:undistorted])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
  ...
  def undistortPoints([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:R,:xi,:K,:D,:distorted,:undistorted])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
