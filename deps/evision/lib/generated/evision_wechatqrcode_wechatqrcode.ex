defmodule Evision.WeChatQRCode.WeChatQRCode do
  ...
  def weChatQRCode([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:detector_caffe_model_path,:super_resolution_prototxt_path,:super_resolution_caffe_model_path,:detector_prototxt_path])
