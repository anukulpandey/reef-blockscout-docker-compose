defmodule Evision.StereoSGBM do
  ...
  def create([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:P1,:preFilterCap,:speckleRange,:numDisparities,:disp12MaxDiff,:P2,:blockSize,:speckleWindowSize,:uniquenessRatio,:minDisparity,:mode])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
