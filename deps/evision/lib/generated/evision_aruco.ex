defmodule Evision.ArUco do
  ...
  def calibrateCameraAruco([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:board,:cameraMatrix,:tvecs,:corners,:counter,:flags,:rvecs,:criteria,:distCoeffs,:imageSize,:ids])
  ...
  def calibrateCameraArucoExtended([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:stdDeviationsIntrinsics,:board,:cameraMatrix,:tvecs,:corners,:counter,:stdDeviationsExtrinsics,:flags,:rvecs,:criteria,:distCoeffs,:imageSize,:perViewErrors,:ids])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
  ...
  def calibrateCameraCharuco([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:board,:cameraMatrix,:tvecs,:charucoIds,:charucoCorners,:rvecs,:flags,:criteria,:distCoeffs,:imageSize])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
  ...
  def calibrateCameraCharucoExtended([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:stdDeviationsIntrinsics,:board,:cameraMatrix,:tvecs,:stdDeviationsExtrinsics,:charucoIds,:charucoCorners,:rvecs,:flags,:criteria,:distCoeffs,:imageSize,:perViewErrors])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
  ...
  def detectCharucoDiamond([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:image,:dictionary,:markerIds,:cameraMatrix,:diamondIds,:distCoeffs,:diamondCorners,:markerCorners,:squareMarkerLengthRate])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
  ...
  def detectMarkers([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:image,:dictionary,:corners,:parameters,:rejectedImgPoints,:ids])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
  ...
  def drawCharucoDiamond([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:dictionary,:marginSize,:markerLength,:img,:borderBits,:ids,:squareLength])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
  ...
  def drawDetectedCornersCharuco([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:cornerColor,:image,:charucoIds,:charucoCorners])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
  ...
  def drawDetectedDiamonds([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:borderColor,:image,:diamondCorners,:diamondIds])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
  ...
  def drawDetectedMarkers([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:corners,:image,:ids,:borderColor])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
  ...
  def drawPlanarBoard([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:board,:marginSize,:outSize,:img,:borderBits])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
  ...
  def estimatePoseBoard([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:rvec,:board,:cameraMatrix,:corners,:useExtrinsicGuess,:distCoeffs,:tvec,:ids])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
  ...
  def estimatePoseCharucoBoard([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:rvec,:board,:cameraMatrix,:charucoIds,:charucoCorners,:useExtrinsicGuess,:distCoeffs,:tvec])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
  ...
  def estimatePoseSingleMarkers([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:objPoints,:estimateParameters,:cameraMatrix,:tvecs,:corners,:rvecs,:markerLength,:distCoeffs])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
  ...
  def extendDictionary([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:nMarkers,:markerSize,:baseDictionary,:randomSeed])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
  ...
  def generateImageMarker([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:dictionary,:sidePixels,:img,:borderBits,:id])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
  ...
  def getBoardObjectAndImagePoints([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:objPoints,:board,:detectedCorners,:detectedIds,:imgPoints])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
  ...
  def interpolateCornersCharuco([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:image,:markerIds,:board,:cameraMatrix,:charucoIds,:charucoCorners,:distCoeffs,:minMarkers,:markerCorners])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
  ...
  def refineDetectedMarkers([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:image,:recoveredIdxs,:board,:cameraMatrix,:rejectedCorners,:parameters,:detectedCorners,:errorCorrectionRate,:detectedIds,:distCoeffs,:checkAllOrders,:minRepDistance])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
