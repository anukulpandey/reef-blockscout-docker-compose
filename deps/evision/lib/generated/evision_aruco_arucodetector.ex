defmodule Evision.ArUco.ArucoDetector do
  ...
  def arucoDetector([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:dictionary,:refineParams,:detectorParams])
  ...
  **Note**: The function does not correct lens distortion or takes it into account. It's recommended to undistort
  ...
  def detectMarkers([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:corners,:image,:ids,:rejectedImgPoints])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
  ...
  **Note**: The function does not correct lens distortion or takes it into account. It's recommended to undistort
  ...
  def refineDetectedMarkers([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:image,:recoveredIdxs,:board,:cameraMatrix,:rejectedCorners,:detectedCorners,:detectedIds,:distCoeffs])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
