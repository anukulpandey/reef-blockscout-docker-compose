defmodule Evision.FishEye do
  ...
  def calibrate([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:imagePoints,:objectPoints,:tvecs,:flags,:rvecs,:criteria,:image_size,:K,:D])
  ...
  def distortPoints([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:alpha,:K,:Kundistorted,:D,:distorted,:undistorted])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
  ...
  def estimateNewCameraMatrixForUndistortRectify([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:R,:new_size,:image_size,:balance,:K,:D,:P,:fov_scale])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
  ...
  def initUndistortRectifyMap([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:R,:m1type,:map2,:K,:D,:size,:map1,:P])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
  ...
  def projectPoints([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:imagePoints,:rvec,:alpha,:objectPoints,:K,:D,:tvec,:jacobian])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
  ...
  def solvePnP([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:imagePoints,:rvec,:cameraMatrix,:objectPoints,:flags,:criteria,:useExtrinsicGuess,:distCoeffs,:tvec])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
  ...
  def stereoCalibrate([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:imagePoints2,:R,:objectPoints,:tvecs,:imagePoints1,:T,:rvecs,:flags,:criteria,:D2,:K1,:D1,:K2,:imageSize])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
  ...
  def stereoRectify([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:P1,:R,:newImageSize,:flags,:R2,:Q,:balance,:D2,:K1,:K2,:D1,:P2,:imageSize,:tvec,:R1,:fov_scale])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
  ...
  def undistortImage([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:new_size,:K,:Knew,:D,:distorted,:undistorted])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
  ...
  def undistortPoints([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:R,:criteria,:K,:D,:P,:distorted,:undistorted])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
