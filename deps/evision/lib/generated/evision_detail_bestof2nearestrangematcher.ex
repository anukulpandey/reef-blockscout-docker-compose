defmodule Evision.Detail.BestOf2NearestRangeMatcher do
  ...
  def bestOf2NearestRangeMatcher([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:num_matches_thresh2,:match_conf,:range_width,:num_matches_thresh1,:try_use_gpu])
  ...
  def apply([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:matches_info,:features1,:features2])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
  ...
  def apply2([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:mask,:pairwise_matches,:features])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
  ...
  def create([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:num_matches_thresh2,:match_conf,:matches_confindece_thresh,:num_matches_thresh1,:try_use_gpu])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
